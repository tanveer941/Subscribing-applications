...
inline void InitDefaults() {
  InitDefaultsBsigDataRequest();
  InitDefaultsBSigDataOfEachSignal();
  InitDefaultsBsigDataResponse();
}
}  // namespace protobuf_Radar_2eproto
namespace Radar {
...
class BsigDataRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Radar.BsigDataRequest) */ {
 public:
  ...
  #if LANG_CXX11
  BsigDataRequest(BsigDataRequest&& from) noexcept
    : BsigDataRequest() {
    *this = ::std::move(from);
  }

  inline BsigDataRequest& operator=(BsigDataRequest&& from) noexcept {
  ...
  friend void swap(BsigDataRequest& a, BsigDataRequest& b) {
    a.Swap(&b);
  }
 ...
 private:
  ...
  friend void ::protobuf_Radar_2eproto::InitDefaultsBsigDataRequestImpl();
};
// -------------------------------------------------------------------
...
class BSigDataOfEachSignal : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Radar.BSigDataOfEachSignal) */ {
 public:
  ...
  #if LANG_CXX11
  BSigDataOfEachSignal(BSigDataOfEachSignal&& from) noexcept
    : BSigDataOfEachSignal() {
    *this = ::std::move(from);
  }

  inline BSigDataOfEachSignal& operator=(BSigDataOfEachSignal&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  friend void swap(BSigDataOfEachSignal& a, BSigDataOfEachSignal& b) {
    a.Swap(&b);
  }
  ...
  double signalvalues(int index) const;
  void set_signalvalues(int index, double value);
  void add_signalvalues(double value);
 ...
 private:
  ...
  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::RepeatedField< double > signalvalues_;
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_Radar_2eproto::TableStruct;
  friend void ::protobuf_Radar_2eproto::InitDefaultsBSigDataOfEachSignalImpl();
};
// -------------------------------------------------------------------
...
class BsigDataResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Radar.BsigDataResponse) */ {
 public:
  ...
  #if LANG_CXX11
  BsigDataResponse(BsigDataResponse&& from) noexcept
    : BsigDataResponse() {
    *this = ::std::move(from);
  }

  inline BsigDataResponse& operator=(BsigDataResponse&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  friend void swap(BsigDataResponse& a, BsigDataResponse& b) {
    a.Swap(&b);
  }
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_Radar_2eproto::TableStruct;
  friend void ::protobuf_Radar_2eproto::InitDefaultsBsigDataResponseImpl();
};
// ===================================================================
